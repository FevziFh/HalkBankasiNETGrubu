        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryDescription = table.Column<string>(type: "nvarchar(250)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "date", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "date", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "date", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookPrice = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    BookStock = table.Column<int>(type: "int", nullable: false),
                    BookDiscount = table.Column<decimal>(type: "decimal(8,2)", nullable: true),
                    BookStockStatus = table.Column<bool>(type: "bit", nullable: false),
                    BookPublishDate = table.Column<DateTime>(type: "date", nullable: true),
