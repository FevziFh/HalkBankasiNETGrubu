...
using _25_EF_DbFirst.Models;

namespace _25_EF_DbFirst.DbContext
{
    public partial class NorthwindContext : Microsoft.EntityFrameworkCore.DbContext
    {
        ...
        public virtual DbSet<AllInOne> AllInOnes { get; set; } = null!;
        public virtual DbSet<AllInOne1> AllInOne1s { get; set; } = null!;
        public virtual DbSet<AlphabeticalListOfProduct> AlphabeticalListOfProducts { get; set; } = null!;
        public virtual DbSet<CalisanBilgileri> CalisanBilgileris { get; set; } = null!;
        ...
        public virtual DbSet<CustomerOrderSummary> CustomerOrderSummaries { get; set; } = null!;
        ...
        public virtual DbSet<ProductStockAndOrder> ProductStockAndOrders { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=KDK-403YZ-PC01;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AllInOne1>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("AllInOne1");
            ...
            modelBuilder.Entity<CalisanBilgileri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CalisanBilgileri");
            ...
            modelBuilder.Entity<CustomerOrderSummary>(entity =>
            {
                ...
                entity.ToView("CustomerOrderSummary");
            ...
            modelBuilder.Entity<ProductStockAndOrder>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductStockAndOrder");
